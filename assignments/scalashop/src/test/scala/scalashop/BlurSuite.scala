...
class BlurSuite extends FunSuite {
  ...
  test("test split to strips") {
    assert(split(3, 1) == List((0,3)))
    assert(split(3, 2) == List((0,2), (2,3)))
    assert(split(5, 2) == List((0,3), (3,5)))
    assert(split(5, 3) == List((0,2), (2,4), (4,5)))
    assert(split(10, 2) == List((0,5), (5,10)))
    assert(split(10, 3) == List((0,4), (4,8), (8,10)))
    assert(split(10, 4) == List((0,3), (3,6), (6,9), (9,10)))
  }
